      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-stretch">
          ...
          <div className="flex flex-col justify-between gap-10">
            ...
            {/* Social Links (Stacked Vertically, Wide and Rectangular) */}
            <div className="flex flex-col gap-3 max-w-md w-full">
              <Link 
                ...
                className="w-full h-12 bg-surface border border-border text-white flex items-center justify-between px-6 rounded-none transition-all duration-300 hover:bg-accent hover:border-accent hover:scale-[1.02] active:scale-[0.98]"
              >
                <span className="font-mono text-[11px] font-bold uppercase tracking-[0.2em]">Instagram</span>
              ...
              <Link 
                ...
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="w-full h-12 bg-surface border border-border text-white flex items-center justify-between px-6 rounded-none transition-all duration-300 hover:bg-[#25D366] hover:border-[#25D366] hover:text-black hover:scale-[1.02] active:scale-[0.98]"
              >
                <span className="font-mono text-[11px] font-bold uppercase tracking-[0.2em]">WhatsApp</span>
              ...
              <Link 
                ...
                className="w-full h-12 bg-surface border border-border text-white flex items-center justify-between px-6 rounded-none transition-all duration-300 hover:bg-accent hover:border-accent hover:scale-[1.02] active:scale-[0.98]"
              >
                <span className="font-mono text-[11px] font-bold uppercase tracking-[0.2em]">YouTube</span>
                <Play size={20} />
              </Link>
            </div>
          </div>
