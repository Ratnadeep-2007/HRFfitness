          ...
          <div className="flex flex-col justify-between gap-10">
            ...
            <div className="flex gap-4">
              <Link 
                ...
                className="w-12 h-12 bg-surface border border-border text-white flex items-center justify-center rounded-none transition-all duration-300 hover:bg-accent hover:border-accent hover:scale-105 active:scale-95"
              >
              ...
              <Link 
                ...
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="w-12 h-12 bg-surface border border-border text-white flex items-center justify-center rounded-none transition-all duration-300 hover:bg-[#25D366] hover:border-[#25D366] hover:text-black hover:scale-105 active:scale-95"
              >
