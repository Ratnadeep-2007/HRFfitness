          ...
          <div className="flex flex-col justify-between gap-10">
            ...
            <div className="flex flex-col gap-3 max-w-md w-full">
              <Link 
                ...
                className="w-full h-12 bg-gradient-to-r from-[#F58529] via-[#DD2A7B] to-[#8134AF] text-white flex items-center justify-center gap-3 rounded-none transition-all duration-300 hover:brightness-110 hover:scale-[1.02] active:scale-[0.98] shadow-lg"
              >
              ...
              <Link 
                ...
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="w-full h-12 bg-surface border border-border text-white flex items-center justify-center gap-3 rounded-none transition-all duration-300 hover:bg-[#25D366] hover:border-[#25D366] hover:text-black hover:scale-[1.02] active:scale-[0.98] shadow-lg"
              >
